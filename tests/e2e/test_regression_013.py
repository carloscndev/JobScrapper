    ...
    def test_dashboard_detail_and_profile_reload_smoke(self) -> None:
        ...
        with sync_playwright() as playwright:
            ...
            try:
                ...
                page.get_by_role("tab", name="Preferencias y pesos").click()
                relocation = page.get_by_role("checkbox", name="Mostrar ofertas que requieren reubicación")
                ...
                page.get_by_role("tab", name="Preferencias y pesos").click()
                self.assertEqual(page.get_by_role("checkbox", name="Mostrar ofertas que requieren reubicación").is_checked(), not initial_relocation)
                page.get_by_role("tab", name="Ofertas").click()
                detail_button = page.get_by_role("button", name="Ver detalle de Senior Backend Engineer en Nubank")
                ...
                application_href = page.get_by_role("link", name="Aplicar").get_attribute("href")
                description_href = page.get_by_role("link", name="Ver descripción original").get_attribute("href")
