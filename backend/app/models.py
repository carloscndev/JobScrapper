...
class Profile(TimestampMixin, Base):
    ...
    reevaluation_required: Mapped[bool] = mapped_column(default=False, nullable=False)
    reevaluation_reason: Mapped[str | None] = mapped_column(String(120))
    reevaluation_metadata: Mapped[dict[str, Any]] = mapped_column(JSON, default=dict, nullable=False)
...
class ProfilePreference(TimestampMixin, Base):
    ...
    seniority: Mapped[str | None] = mapped_column(String(40))
    preferred_languages: Mapped[list[Any]] = mapped_column(JSON, default=list, nullable=False)
    ...
    excluded_constraints: Mapped[list[Any]] = mapped_column(JSON, default=list, nullable=False)
